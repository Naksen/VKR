...
const LayoutLaundriesRoute = LayoutLaundriesImport.update({
  path: '/laundries',
  getParentRoute: () => LayoutRoute,
} as any)

const LayoutPublicAreasRoute = LayoutPublicAreasImport.update({
  path: '/public_areas',
  getParentRoute: () => LayoutRoute,
} as any)

const LayoutIssuesRoute = LayoutIssuesImport.update({
  path: '/issues',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/laundries': {
      preLoaderRoute: typeof LayoutLaundriesImport
      parentRoute: typeof LayoutImport
    }
    '/_layout/public_areas': {
      preLoaderRoute: typeof LayoutPublicAreasImport
      parentRoute: typeof LayoutImport
    }
    '/_layout/issues': {
